...
async def main():
    ...
    Telethon session file (`lead_finder_session.session`).
    ...
    Once the `lead_finder_session.session` file is created, the main bot
    ...
    if await client.is_user_authorized():
        ...
        print("A 'lead_finder_session.session' file has been created/updated.")
